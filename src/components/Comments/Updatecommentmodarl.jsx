...
function Updatecommentmodarl({Setopen,text,commentId}) {
    ...
    return (
        <div className='bg-black fixed top-0 left-0 bottom-0 right-0 flex z-10 bg-opacity-40 items-center justify-center'>
...
export default Updatecommentmodarl
